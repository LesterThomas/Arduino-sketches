/************************************************************************/
/* This module uses the X10 library by Thomas Mittet thomas@mittet.nu   */
/*                                                                      */
/* The program interfaces with X10 (simple commands over house wiring   */
/* It also has a serial connection to an Arduino Ethernet Module that   */
/* provides a simple website to access the X10 commands                 */
/************************************************************************/
